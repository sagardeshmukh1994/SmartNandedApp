...
public class Activity_Offers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__offers);
    ...
    private void getProducts() {
        ...
        leedRepository.readProductsByCategory(Constant.CATEGORY_OFFERS, new CallBack() {
            @Override

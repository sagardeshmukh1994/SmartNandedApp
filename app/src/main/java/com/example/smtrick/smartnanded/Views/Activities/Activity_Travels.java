...
public class Activity_Travels extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__travels);
    ...
    private void getProducts() {
        ...
        leedRepository.readProductsByCategory(Constant.CATEGORY_TRAVELS, new CallBack() {
            @Override

...
public class Activity_Aggriculture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__aggriculture);
    ...
    private void getProducts() {
        ...
        leedRepository.readProductsByCategory(Constant.CATEGORY_AGRICULTURE, new CallBack() {
            @Override

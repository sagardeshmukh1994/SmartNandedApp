...
public class Activity_Cars extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__cars);
    ...
    private void getProducts() {
        ...
        leedRepository.readProductsByCategory(Constant.CATEGORY_CAR, new CallBack() {
            @Override
